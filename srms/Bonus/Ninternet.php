...
<table id="seminarSheet" class="table table-bordered "><center>
  ...
  <h3>Internet hour activities </h3>
</center>
  <tr>
    <td>rollno</td>
    <td>name</td>
    <td>Attendence<br>out of 1</td>
    <td>Evaluation<br>out of 4</td>
    <td>Total marks<br>out of 5</td>
  </tr>
  </td>
...
function changeSheet(){window.location.assign("internet.php");}
</script>
