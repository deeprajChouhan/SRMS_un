...
<table id="seminarSheet" class="table table-bordered "><center>
  ...
  <h3>Apptitude Sheet</h3>
</center>
  <tr>
    <td>rollno</td>
    <td>name</td>
    <td>Aptitude 1<br>out of 1</td>
    <td>Aptitude 2<br>out of 1</td>
    <td>Aptitude Certification<br>out of 3</td>
    <td>Total</td>
  </tr>
  </td>
...
function changeSheet(){window.location.assign("aptitude.php");}
</script>
