...
<?php
  if(isset($_POST['submit'])){
    ...
    $res_branch = $conn->query("select * from branches where username = '$username' AND password='$password'");
    ...
    if($username == $row_branch['username'] && $password == $row_branch['password']) echo "<script>window.location.assign('../admin')</script>";
  }
?>
