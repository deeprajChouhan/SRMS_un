...
<p class="alignleft"><a style="border:none;background-color:none;" href="../classteacher1.php">
    ...
    <button class="btn btn-danger" style="margin-left:20%;" ng-click="send_data()">Update</button>
                        ...
                        for($i=0;$i<sizeof($subjects);$i++){
                            echo "<td>
                                <table class='table table-bordered table-condensed'>
                                    ...
                                    <td style='width:50%;'><input style='width:50%;' ng-blur='update(x.roll,x.name,x.".$subjects[$i].",x.".$subjects[$i]."B,x.col".$i.")' type='text'  ng-model='x.".$subjects[$i]."B'></td>
...
<script>
    ...
    app.controller("myCtrl",function($http,$scope){
        ...
        $scope.send_data = function(){
            window.location.assign("update.php?id="+$scope.string);
        }
    });
</script>
</html>